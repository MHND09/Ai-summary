...
def getSessionSummary(id):
    ...
    try:
        ...
        **Prompt:**
        ...
        4. **Summary Construction**: Create a structured summary that includes:
           - An introductory statement about the session's purpose.
           - A detailed breakdown of the main points discussed, categorized by topic.
           - Any conclusions or action items that were highlighted during the session.
           - If relevant, include any questions raised or unresolved issues noted on the whiteboard.

        5. **Clarity and Coherence**: Ensure that the summary is clear, concise, and coherent. Use bullet points or numbered lists where appropriate to enhance readability.
        ...
        and allways add the following to the end of the summary:
